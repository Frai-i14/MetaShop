$(document).ready(function(){
    ...
    function toggleBlockWork(elem){
        ...
        if (window.screen.width <= 992){
            elem.parentNode.parentNode.nextElementSibling.scrollIntoView({block: "center", inline: "center", behavior: "smooth"});
        }
    ...
    $('.work__wrap_block_item').on('click', function (){
        ...
        if (window.screen.width <= 992){
            this.parentNode.scrollIntoView({block: "center", inline: "center", behavior: "smooth"});
        }
